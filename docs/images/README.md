...
Drop PNGs here using the filenames referenced from the how-to docs. Each `> 📸 **Screenshot needed:**` callout in the docs names the exact file to add.

## Index of expected images

| Filename | Used in | What to capture |
| --- | --- | --- |
| `new-chat-button.png` | [prune-history](../prune-history.md) | Chat view title bar with the **+ New Chat** icon highlighted |
...
| `add-context-menu.png` | [manage-context](../manage-context.md) | Add Context menu expanded |
| `add-selection.png` | [manage-context](../manage-context.md) | Right-click menu with "Add Selection to Chat" |
| `slash-commands.png` | [focused-questions](../focused-questions.md) | Chat input showing `/` suggestion popup |
...
- Use a light or dark theme consistently across all images.
- Highlight the target element with a colored rectangle (red works well).
- Keep image width ~1200px max for readable inline rendering.
- Save as PNG.
